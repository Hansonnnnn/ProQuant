...
public class StrategyEvalutingVO {
    ...
    public StrategyEvalutingVO() {
    	this.earningsValue = (int)(Math.random()*100);
        this.realPlateValue = (int)(Math.random()*100);
        this.robustnessValue = (int)(Math.random()*100);
        this.mobilityValue =(int)(Math.random()*100);
        this.anti_riskValue = (int)(Math.random()*100);
    }
